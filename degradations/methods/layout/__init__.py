...
from .cadre_rectangle import transforms_cadre_rectangle
...
__all__ = ["transforms_cadre", "transforms_cadre_rectangle", "transforms_patchwork", "transforms_photo_montage", "transforms_picture_overlay", "transforms_text_overlay"]